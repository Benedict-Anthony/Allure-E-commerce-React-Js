...
const SignIn = () => {
  ...
  return (
    <section className='container'>
      {modal ? (
        <Modal>
          <h1>Account was create succesfuly.</h1>
          <p>An email was sent to you, link provided in the email to activate your account</p>
          <p>if having issue, pleascheck your span folder</p>
